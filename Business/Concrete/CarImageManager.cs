...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        //İŞ KURALI PARÇACIKLARI
        private List<CarImage> CheckIfCarImageNull(int id)
        {
            string path = Path.Combine(Directory.GetParent(System.IO.Directory.GetCurrentDirectory()).FullName + @"\Uploads\blank.jpg");
        ...
        private IResult CheckIfImageLimit(int carid)
        {
            ...
            if (carImagecount >= 5)
            {
                return new ErrorResult(Messages.ImageLimitAlert);
            }
